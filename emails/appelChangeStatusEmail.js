const appelChangeStatusEmailHtml = (headText, status, date, text) => {return `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                              ...
                              <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px;color: #FFFFFF; line-height: 140%; text-align: center;">Отслеживать статус обращения можно на сайте в разделе "Мои обращения".</p>
                                <p style="font-size: 14px;color: #FFFFFF; line-height: 140%; text-align: center; margin-top:15px;">При изменении статуса обращеня Вам будет отправлено письмо.</p>
                              </div>
...
`}
module.exports = appelChangeStatusEmailHtml